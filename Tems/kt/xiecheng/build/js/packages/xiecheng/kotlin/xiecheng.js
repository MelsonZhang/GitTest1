(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'xiecheng'.");
    }
    if (typeof this['kotlin-react'] === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'kotlin-react' was not found. Please, check whether 'kotlin-react' is loaded prior to 'xiecheng'.");
    }
    if (typeof this['react-dom/client'] === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'react-dom/client' was not found. Please, check whether 'react-dom/client' is loaded prior to 'xiecheng'.");
    }
    if (typeof react === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'react' was not found. Please, check whether 'react' is loaded prior to 'xiecheng'.");
    }
    if (typeof this['kotlin-react-dom'] === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'kotlin-react-dom' was not found. Please, check whether 'kotlin-react-dom' is loaded prior to 'xiecheng'.");
    }
    if (typeof this['kotlin-csstype'] === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'kotlin-csstype' was not found. Please, check whether 'kotlin-csstype' is loaded prior to 'xiecheng'.");
    }
    if (typeof this['kotlin-emotion'] === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'kotlin-emotion' was not found. Please, check whether 'kotlin-emotion' is loaded prior to 'xiecheng'.");
    }
    if (typeof this['kotlin-react-core'] === 'undefined') {
      throw new Error("Error loading module 'xiecheng'. Its dependency 'kotlin-react-core' was not found. Please, check whether 'kotlin-react-core' is loaded prior to 'xiecheng'.");
    }
    root.xiecheng = factory(typeof xiecheng === 'undefined' ? {} : xiecheng, kotlin, this['kotlin-react'], this['react-dom/client'], react, this['kotlin-react-dom'], this['kotlin-csstype'], this['kotlin-emotion'], this['kotlin-react-core']);
  }
  ...
  main();
  Kotlin.defineModule('xiecheng', _);
  return _;
}));

//# sourceMappingURL=xiecheng.js.map
